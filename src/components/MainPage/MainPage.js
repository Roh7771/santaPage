...
export default function MainPage(props) {
  return (
    <div className='container d-flex flex-column justify-content-center align-items-center vh-100'>
      ...
      <div className='text animated fadeIn delay-3s'>Твой вчерашний ответ оказался неверным :(</div>
      <div className='text animated fadeIn delay-3s'>Но не расстраивайся.</div>
      <div className='text animated fadeIn delay-6s'>Ты все равно получишь утешительный приз.</div>
